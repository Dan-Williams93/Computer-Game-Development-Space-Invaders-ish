...
namespace Invaders
{
    public class MediumAsteroid
    {
        ...
        public Rectangle mediumAsteroidRectangle;
        ...
        public MediumAsteroid(Texture2D newTexture, Vector2 newPosition)
        {
            screenHeight = 900;
            screenWidth = 1440;
            //asteroidHeight = 55;
        ...
        {
            mediumAsteroidRectangle = new Rectangle((int)position.X, (int)position.Y, texture.Width, texture.Height);
